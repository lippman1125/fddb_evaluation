...
plot  "voc2012_person_pvanet_lite_gpu_PR.txt" using 2:1 title 'voc2012 person pvanet gpu PR' with linespoints pointinterval 50 lw 3, \
      "voc2012_person_pvanet_lite_fix8_PR.txt" using 2:1 title 'voc2012 person pvanet fix8 PR' with linespoints pointinterval 50 lw 3, \
      ...
      "voc2012_person_pvanet_lite_gpu_minsize30_PR.txt" using 2:1 title 'voc2012 person pvanet gpu 30 PR' with linespoints pointinterval 50 lw 3
