...
void printUsage(){
  ...
  cout << "   -c format       : representation of faces in the anno file (default: 0)" << endl;
...
#ifndef _WIN32
  // parse the input
  while( (c = getopt(argc, argv, "l:r:d:a:c:z:i:f:s")) != -1){
    switch(c){
      case 'l':
	listFile = optarg;
	break;
